...
class Admin::CategoryResellerDiscountsControllerTest < ActionController::TestCase
  def test_index
    get :index
  ...
  def test_create_valid
    ...
    post :create
    assert_redirected_to admin_category_reseller_discount_url(assigns(:category_reseller_discount))
  end
  ...
  def test_destroy
    ...
    assert_redirected_to admin_category_reseller_discounts_url
